...
namespace Hishop.Plugins.Payment
{
    public class DataHelper
    {
        ...
        /// <returns></returns>
        public static string CoverDictionaryToString(IDictionary<string, string> data)
        {
        ...
        public static string RSA(string content, string privateKey, string input_charset)
        {
        ...
        /// <param name="input_charset">编码格式</param>
        /// <returns></returns>
        public static bool RSA_Verify(string content, string signedString, string publicKey, string input_charset)
        {
            bool result = false;
