...
namespace Hishop.Plugins.Payment.BankUnionGateWay.sdk
{
    public class SDKUtil
    {
        ...
        public static bool Validate(Dictionary<string, string> data, Encoding encoder)
        {
            ...
            //return CertUtil.ValidateCertId(data["certId"]);
            ...
            bool result = SecurityUtil.ValidateBySoft(provider, signByte, encoder.GetBytes(stringSignDigest));
        ...
        public static string encryptPin(string card, string pwd, string encoding)
        {
            ...
            X509Certificate2 pc = new X509Certificate2(SDKConfig.publicCertPath);
