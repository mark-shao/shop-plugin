...
{
    public interface IResponseMessageBase : HiShop.API.Setting.Entities.IResponseMessageBase
	{
	...
	/// 响应回复消息
	/// </summary>
    public class ResponseMessageBase : HiShop.API.Setting.Entities.ResponseMessageBase, IResponseMessageBase
	{
