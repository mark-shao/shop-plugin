...
namespace HiShop.API.Setting.HttpUtility
{
    public static class RequestUtility
    {
        ...
        public static string HttpGet(string url, Encoding encoding = null, string appId = "", string appSecret = "", string accessToken = "")
        {
            ...
            {
                byte[] authBytes = Encoding.UTF8.GetBytes(string.Format("{0}:{1}", appId, appSecret).ToCharArray());
        ...
        /// </summary>
        /// <returns></returns>
        public static string HttpPost(string url, CookieContainer cookieContainer = null, Dictionary<string, string> formData = null, Encoding encoding = null, int timeOut = Config.TIME_OUT, string appid = "", string appSecret = "")
        {
            MemoryStream ms = new MemoryStream();
            formData.FillFormDataStream(ms);//填充formData
            return HttpPost(url, cookieContainer, ms, null, null, encoding, timeOut, appid, appSecret);
        }
        ...
        /// <returns></returns>
        public static string HttpPost(string url, CookieContainer cookieContainer = null, Stream postStream = null, Dictionary<string, string> fileDictionary = null, string refererUrl = null, Encoding encoding = null, int timeOut = Config.TIME_OUT, string appId = "", string appSecret = "", string accessToken="",string method="POST", bool checkValidationResult = false)
        {
            HttpWebResponse response = null;
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
