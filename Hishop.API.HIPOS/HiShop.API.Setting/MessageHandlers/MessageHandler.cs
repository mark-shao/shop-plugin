...
namespace HiShop.API.Setting.MessageHandlers
{
        ...
        where TResponse : IResponseMessageBase
    {
        ...
        /// 如果是HiShop.API.Setting.QY，则应当和ResponseDocument一致；如果是HiShop.API.Setting.QY，则应当在ResponseDocument基础上进行加密
        /// </summary>
        ...
        public MessageHandler(RequestMessageBase requestMessageBase, int maxRecordCount = 0, object postData = null)
        {
            ...
            //此方法不执行任何方法，提供给具体的类库进行测试使用，例如HiShop.API.Setting.QY
        }
