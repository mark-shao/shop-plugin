...
namespace Aop.Api.Util
{
    public class AlipaySignature
    {
        ...
        public static string RSASign(IDictionary<string, string> parameters, string privateKeyPem ,string charset = "UTF-8")
        {
            string signContent = GetSignContent(parameters);

            return RSASign(signContent, privateKeyPem, charset);
        }
        ...
        public static string encryptAndSign(string bizContent, string alipayPublicKey,
                                        ...
                                        bool isSign,bool needHeader=true)
        {
