...
{
    public class Yfx1_2_to_Taobao4_7 : ExportAdapter
    {
        ...
        public Yfx1_2_to_Taobao4_7(params object[] exportParams)
            : this()
        {
        ...
        private string GetProductCSV()
        {
            ...
            foreach (DataRow row in _exportData.Tables["products"].Rows)
            {
                ...
                sb.AppendFormat(productFormat,
                            Trim(Convert.ToString(row["ProductName"])), "0", "", "0", "", "", "b", srows[0]["SalePrice"], "0",
